...
namespace survey_maker_backend.Migrations
{
    ...
    [Migration("20260210000052_addSurveyData")]
    partial class addSurveyData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyMaker.Core.Entities.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SurveyMaker.Core.Entities.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QuestionSurvey", b =>
                {
                    b.HasOne("SurveyMaker.Core.Entities.Question", null)
                        .WithMany()
                        .HasForeignKey("QuestionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurveyMaker.Core.Entities.Survey", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurveyMaker.Core.Entities.Answer", b =>
                {
                    b.HasOne("SurveyMaker.Core.Entities.SurveyResponse", "SurveyResponse")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("SurveyMaker.Core.Entities.Option", b =>
                {
                    b.HasOne("SurveyMaker.Core.Entities.Question", "Question")
                        .WithMany("Options")
